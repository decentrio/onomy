...
onomyd tx vaults create-vault 15000000000anom 50000000fxUSD --from test2 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id onomy-mainnet-1 -y
...
# onomyd tx auction bid 0 15000000fxUSD 0.024 --from test1 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id onomy-mainnet-1 -y

# sleep 7

echo "I will buy all the remaining"
# onomyd tx auction bid 0 47500000fxUSD 0.019 --from test3 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id onomy-mainnet-1 -y
