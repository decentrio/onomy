...
onomyd tx auction bid 0 15000000fxUSD 6.0 --from test1 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id onomy-mainnet-1 -y

sleep 7

echo "I will buy all the remaining"
onomyd tx auction bid 0 50000000fxUSD 5.0 --from test3 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id onomy-mainnet-1 -y
