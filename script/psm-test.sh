...
onomyd tx oracle set-price fxUSD 1 --home=$HOME/.onomyd/validator1  --from validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y
...
echo "========swap==========="
onomyd tx psm swap-to-fxUSD 100000000000000000000000000000usdt --from validator1 --keyring-backend test --home ~/.onomyd/validator1 --chain-id testing-1 -y --fees 20stake

sleep 7
# Check account after swap
onomyd q bank balances $(onomyd keys show validator1 -a --keyring-backend test --home /Users/donglieu/.onomyd/validator1)

# tx swap fxUSD to usdt
onomyd tx psm swap-to-stablecoin usdt 1000fxUSD --from validator1 --keyring-backend test --home ~/.onomyd/validator1 --chain-id testing-1 -y --fees 20stake
...
onomyd tx bank send $( onomyd keys show validator1 --home=$HOME/.onomyd/validator1  --keyring-backend test -a) $(onomyd keys show test1 --home=$HOME/.onomyd/validator1  --keyring-backend test -a) 20000000fxUSD,10000stake,10000000usdt --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y
...
# onomyd tx vaults create-vault 10000000atom 20000000fxUSD --from validator1 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y
...
# onomyd tx vaults repay 0 10000000000000000fxUSD --from validator1 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y
