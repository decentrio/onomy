...
import (
	...
	v2_2_5 "github.com/onomyprotocol/onomy/app/upgrades/v2.2.5"
...
func (app *OnomyApp) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(v2_2_5.Name, v2_2_5.CreateUpgradeHandler(app.mm, app.configurator, &app.AppKeepers))
